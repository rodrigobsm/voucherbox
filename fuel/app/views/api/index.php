<style>
    ...
    h6 {
        ...
        font-size: 22px;
        margin-top: 50px;
        border-bottom: 2px solid #2aca76;
        background: #2aca76;
        padding: 10px;
...
<ol>
    ...
    <li><a href="#list">List</a>: Used to list all available voucher coude for a given recipient' e-mail address.</li>
</ol>
<hr>
...
<p>This method should be called to validate a voucher code and an e-mail address. It will check if that voucher belongs to the recipients e-mail address, it will also check if it is expired or has already been used.</p>
...
<p>In case of success, it will return a HTTP status code iquals to 200, the parameter 'return' iquals to 0 and the parameter discount with the reference discount allowed for that voucher. This voucher will now be marked as used with today' date. In the below example, the discount allowed is 15% OFF.</p>
<ul>
    <li><b>Code</b>: 200</li>
    <li><b>Content</b>:<br>
<code>
...
<p>In case of error, it will return an error code in JSON, an error message and a corresponding HTTP status code as below:</p>
<table>
    <thead>
    <th>HTTP Status</th>
    <th>Return Code</th>
...
<p>This method should be called to list which vouchers are currently available for a given recipient's e-mail address.</p>
...
<p><b>Data Parameters</b>: No data in the body payload.<br>
<p><b>Success Response</b>:<br>
<p>In case of success, it will return a HTTP status code iquals to 200, the parameter 'return' iquals to 0 and a list of currently available vouchers to be used with corresponding voucher code and offer name.</p>
<ul>
    <li><b>Code</b>: 200</li>
    <li><b>Content</b>:<br>
        <code>
